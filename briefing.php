...
define('PAGE','BRIEFING');
define('PAGE_NAME', '전문가브리핑');
define('PAGE_PATH', 'briefing');


require_once ('./inc/common-data.php');


use JCORP\Business\BriefingService\BriefingService as BriefingService;
$inc=new BriefingService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-briefing.jpg" alt="" width="100%" />
        </div>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-briefing.jpg" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">애널리스트 종목브리핑</span>
            </div>
