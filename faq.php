...
define('PAGE','FAQ');
define('PAGE_NAME', '자주묻는질문답변');
define('PAGE_PATH', 'faq');


require_once ('./inc/common-data.php');


use JCORP\Business\FaqService\FaqService as FaqService;
$inc=new FaqService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-faq.jpg" alt="" width="100%" />
        </div>
        <table class="vt-group-info-table jp-group-info-table">
                ...
                <tr>
                    <td>
                        <div class="question-section">
                            <img src="<?php echo ROOT;?>assets/img/pc/ico-question.jpg" alt="" width="15" />&nbsp;
                            ...
                            <img src="<?php echo ROOT;?>assets/img/pc/ico-angle-up.jpg" alt="" class="ico-show" width="12" />
                            <img src="<?php echo ROOT;?>assets/img/pc/ico-angle-down.jpg" alt="" class="ico-hide" width="12" />

                        </div>
                        <div class="answer-section">
                            <img src="<?php echo ROOT;?>assets/img/pc/ico-answer.jpg" alt="" width="15" style="position: absolute; top: 20px; left: 15px;" />
                            <div class="answer-section-body"><?php echo html_entity_decode($lists[$i]['contents']);?></div>
                        </div>
                    </td>
                </tr>
            <?php } ?>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-faq.jpg" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">FAQ</span>
            </div>
...
<script>
    $('.question-section').bind('click', function (e){
        e.preventDefault();

        if($(this).hasClass('active-question-tab') === true){
            $(this).removeClass('active-question-tab');
        }else{
            $('.question-section').removeClass('active-question-tab');
            $(this).addClass('active-question-tab');
        }
    });
</script>
</body>
