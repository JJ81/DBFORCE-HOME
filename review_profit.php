...
define('PAGE_PATH', 'review_profit');


require_once ('./inc/common-data.php');


use JCORP\Business\ReviewProfitService\ReviewProfitService as ReviewProfitService;
$inc=new ReviewProfitService();
                    ...
                    <div class="page-pc-thumbnail-list page-pc-thumbnail-list-type-B">
                        <a href="<?php echo ROOT;?><?php echo PAGE_PATH;?>_view.php?id=<?php echo $lists[$i]['id'];?>">
                            <span class="thumbnail-wrp">
                                <img src="<?php echo ROOT;?>assets/uploads/review_profit/<?php echo $lists[$i]['thumbnail'];?>" alt="" width="100%" />
                            </span>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">고객성공후기</span>
            </div>
