...
define('PAGE','SOCIAL');
define('PAGE_NAME', '사회공헌');
define('PAGE_PATH', 'social');


require_once ('./inc/common-data.php');


use JCORP\Business\Social\SocialService as SocialService;
$inc=new SocialService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-social.jpg" alt="" width="100%" />
        </div>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-media.jpg" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis"><?php echo PAGE_NAME;?></span>
            </div>
