                            ...
                            <div class="_container">
                                <form action="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/response/res_write.php" method="post" enctype="multipart/form-data" class="form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="">최대수익율</label>
                                                <input type="text" name="max_profit_rate" placeholder="최대수익율" class="form-control form-title" autofocus required />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="">최대수익금</label>
                                                <input type="text" name="max_profit_price" placeholder="최대수익금" class="form-control form-title" required />
                                            </div>
                                        </div>
                                    </div>
