...
$stock_title=getDataByPost('stock_title'); // 종목명
...
$thumbnail=null;
$UPLOAD_DIR_IMAGE=BEST_PROFIT_IMG_PATH;
$newImgName=null;
...
$result_update=$inc->updateList($title, $thumbnail, $html, $author, $hits, $external_link, $link_origin, $id, $date, $stock_title, $max_profit_rate, $max_profit_price);
