...
$rows=$media->getList($offset, $size);
?>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php }else{ ?>
                                        <?php foreach ($rows as $r) { ?>
                                            <tr>
                                                <th class="center" scope="row"><?php echo $r['id'];?></th>
                                                ...
                                                <td class="center">
                                                    <?php if(!empty($r['external_link'])){ ?>
                                                    <a href="<?php echo $r['external_link']?>" target="_blank" class="color-primary">연결 링크</a>
                                                    <?php }else{ ?>
                                                        -
                                                    <?php } ?>
                                                </td>
...
<!--                                                    <a href="--><?php //echo ROOT;?><!--admin/--><?php //echo TARGET_FOLDER;?><!--/view.php?id=--><?php //echo $r['id'];?><!--" class="btn btn-sm btn-outline-success">보기</a>-->
                                                    ...
                                                    <a href="#" data-notice-id="<?php echo $r['id'];?>"
                                                       class="btn btn-sm btn-outline-danger js-delete-board">삭제</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
...
<script>
    ...
    btnDelete.bind('click', function (e) {
        ...
        swal({
            ...
            if(isConfirm){
                axios.get('/api/media/delete_board_by_id.php?id=' + _notice_id)
                    .then(function (res) {
                        if(res.data.success){
                            swal(
                                '삭제!',
