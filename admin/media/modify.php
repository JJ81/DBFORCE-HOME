...
define('PAGE','MEDIA');
define('PAGENAME', '언론보도');
define('TARGET_FOLDER', 'media');
                                ...
                                <form action="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/response/res_modify.php" method="post" enctype="multipart/form-data" class="form">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label for="">글 간략노출 <small class="text-danger">(*)</small></label>
                                                <input type="text" name="desc" placeholder="미리보기 글 노출" class="form-control form-title" value="<?php echo replaceQuotationMark($row[0]['desc']); ?>" required />
                                            </div>
                                        </div>
                                    </div>
