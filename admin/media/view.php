                    ...
                    <div class="card">
                        <div class="card-title clearfix">
                            <span class="pull-right">
                                <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/modify.php?id=<?php echo $row[0]['id']; ?>" class="btn btn-danger btn-sm">수정</a>
                                <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/" class="btn btn-sm btn-primary">목록으로</a>
                            </span>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" style="text-align: left;">
                                            <?php echo replaceQuotationMark($row[0]['desc']); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>공지일</th>
                                        <td align="left" style="text-align: left;" colspan="5"><?php echo setDate($row[0]['registered_dt']);?></td>
                                    </tr>
