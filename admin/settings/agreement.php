...
$basic=new Basic();
$row=$basic->getAgreementInfo($company_id);
?>
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">이용약관</h3></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="_container">
                                <form action="./response/res_agreement.php" method="post" class="form">
                                    <!-- smart editor -->
                                    <div>
                                        <textarea name="ir1"
                                                  id="ir1"
                                                  rows="10"
                                                  cols="100"
                                                  style="display:none;"><?php if(!empty($row[0]['agreement'])) {echo html_entity_decode($row[0]['agreement']);} ?></textarea>
                                    </div>
                                    <!-- // smart editor -->
