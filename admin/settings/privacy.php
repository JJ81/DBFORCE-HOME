    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-primary">개인정보취급방침</h3></div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active">개인정보취급방침</li>
                </ol>
            </div>
        </div>
        <!-- End Bread crumb -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="_container">
                                <form action="./response/res_privacy.php" method="post" class="form">
                                    <!-- smart editor -->
                                    <div>
                                        <textarea name="ir1"
                                                  id="ir1"
                                                  rows="10"
                                                  cols="100"
                                                  style="display:none;"><?php if(!empty($privacy[0]['privacy'])) {echo html_entity_decode($privacy[0]['privacy']);} ?></textarea>
                                    </div>
                                    <!-- // smart editor -->
