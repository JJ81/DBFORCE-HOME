...
define('PAGE','INTERVIEW');
define('PAGENAME', '고객인터뷰');
define('TARGET_FOLDER', 'interview');
...
<!--                                        </div>-->
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="">영상ID <small class="text-danger">(*)</small></label>
                                                <input type="text" name="video" class="form-control form-date" value="<?php echo $row[0]['youtube_link']; ?>" placeholder="예시) m2qZUSZIgfM" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
