...
$thumbnail=null;
$UPLOAD_DIR_IMAGE=NEWS_IMG_PATH; // 뉴스 이미지 업로드 경로
$newImgName=null;
...
$insertId=$news->setList($title, $thumbnail, $html, $author, $hits, $external_link, $link_origin, $date);

if(!empty($insertId)){
    Redirect(ROOT . 'admin/news/view.php?id=' . $insertId);
}else{
