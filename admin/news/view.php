                    ...
                    <div class="card">
                        <div class="card-title clearfix">
                            <span class="pull-right">
                                <a href="<?php echo ROOT;?>admin/news/modify.php?id=<?php echo $row[0]['id']; ?>" class="btn btn-danger btn-sm">수정</a>
                                <a href="<?php echo ROOT;?>admin/news/" class="btn btn-sm btn-primary">목록으로</a>
                            </span>
                        </div>
                        <div class="card-body">
