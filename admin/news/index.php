                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title clearfix">
                            ...
                            <a href="<?php echo ROOT;?>admin/news/write.php" class="btn btn-outline-info pull-right">글쓰기</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <?php }else{ ?>
                                        <?php foreach ($rows as $r) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($r['pickup'] == '1'){?>
<!--                                                        <a href="#" class="btn btn-sm btn-outline-primary js-remove-main" data-news-id="--><?php //echo $r['id'];?><!--">메인해제</a>-->
                                                    <?php }else{ ?>
<!--                                                        <a href="#" class="btn btn-sm btn-primary js-set-main" data-news-id="--><?php //echo $r['id'];?><!--">메인설정</a>-->
                                                    <?php } ?>

                                                    <a href="<?php echo ROOT;?>admin/news/view.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-outline-success">보기</a>
                                                    <a href="<?php echo ROOT;?>admin/news/modify.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-outline-warning">수정</a>
                                                    <a href="#" data-notice-id="<?php echo $r['id'];?>" class="btn btn-sm btn-outline-danger js-delete-notice">삭제</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                ...
                                <?php if(count($rows) !== 0){ ?>
                                    <nav class="clearfix" style="margin-top: 20px;position: relative;" >
                                        <ul class="pagination pull-left">
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/news/?size=<?php echo $size;?>&page=1" tabindex="-1">First</a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/news/?size=<?php echo $size;?>&page=<?php echo $prev;?>" tabindex="-1">Previous</a>
                                            </li>
                                            <li class="page-item">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/news/?size=<?php echo $size;?>&page=<?php echo $next;?>">Next</a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/news/?size=<?php echo $size;?>&page=<?php echo $total_page;?>" tabindex="-1">Last</a>
                                            </li>
                                        </ul>
                                    </nav>
                                <?php } ?>
...
<script>
    ...
    btnDelete.bind('click', function (e) {
        ...
        swal({
            ...
            if(isConfirm){
                axios.get('/api/news/delete_news_by_id.php?id=' + _notice_id)
                    .then(function (res) {
                        if(res.data.success){
                            swal(
                                '삭제!',
    ...
    $('.js-remove-main').bind('click', function (e){
        ...
        axios.get('/api/news/remove_from_main_by_id.php?id=' + news_id)
            .then(function (res) {
                if(res.data.success){
                    swal(
                        '노출해제',
