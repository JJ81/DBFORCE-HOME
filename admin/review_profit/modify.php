...
define('PAGE','REVIEW_PROFIT');
define('PAGENAME', '고객성공후기');
define('TARGET_FOLDER', 'review_profit');
...
$id=getDataByGet('id');
use JCORP\Business\ReviewProfitService\ReviewProfitService as ReviewProfit;
$inc=new ReviewProfit();
