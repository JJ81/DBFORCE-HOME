...
define('PAGE_NAME', 'review_profit');
...
$thumbnail=null;
$UPLOAD_DIR_IMAGE=REVIEW_PROFIT_IMG_PATH;
$newImgName=null;
...
$result_update=$inc->updateList($title, $thumbnail, $html, $author, $hits, $external_link, $link_origin, $id, $date);
