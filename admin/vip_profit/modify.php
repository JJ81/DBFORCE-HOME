...
define('PAGENAME', 'VIP투자성과');
define('TARGET_FOLDER', 'vip_profit');
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="author" class="form-control form-author" placeholder="작성자를 입력해 주세요." required value="<?php echo $row[0]['author'] ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="stock_title" placeholder="종목명" class="form-control form-title" required value="<?php echo $row[0]['stock_title'] ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="purchase_date" class="form-control form-date" value="<?php echo $row[0]['purchase_date'] ?>" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="purchase_price" placeholder="매입가를 입력하세요." class="form-control form-title" required value="<?php echo $row[0]['purchase_price'] ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="sell_date" class="form-control form-date" value="<?php echo $row[0]['sell_date'] ?>" required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="sell_price" placeholder="매도가를 입력하세요." class="form-control form-title" required value="<?php echo $row[0]['sell_price'] ?>" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="rate" placeholder="수익률을 입력하세요." class="form-control form-title" required value="<?php echo $row[0]['profit_rate'] ?>" />
                                            </div>
                                        </div>
                                    </div>
