                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                <label for="">제목/질문 <small class="text-danger">(*)</small></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date" class="form-control form-date" value="<?php echo setDate($row[0]['registered_dt']); ?>" required />
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="">작성자</label>
                                                <input type="text" name="author" class="form-control form-author" value="<?php echo $row[0]['author'] ?>" placeholder="작성자를 입력해 주세요." required />
                                            </div>
                                        </div>
                                    </div>
...
<!--                                        <textarea name="ir1" id="ir1" rows="10" cols="100" style="width: 100%; height:412px; display:none;">--><?php //echo $row[0]['contents'] ?><!--</textarea>-->
                                        <textarea name="ir1" rows="10" cols="100" style="width: 100%; height:412px;" class="form-control" required><?php echo $row[0]['contents'] ?></textarea>
                                    </div>
                                    <!-- smart editor -->
