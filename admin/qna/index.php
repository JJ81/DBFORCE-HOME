                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-title clearfix">
                            ...
                            <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/write.php" class="btn btn-outline-info pull-right">글쓰기(질문)</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php }else{ ?>
                                        <?php foreach ($rows as $r) { ?>
                                            <tr>
                                                <th scope="row"><?php echo $r['rnum'];?></th>
                                                ...
                                                <td>
                                                    <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/modify.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-outline-warning">질문수정</a>

                                                    <?php if(!empty($r['a_id'])){ ?>
                                                        <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/modify_answer.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-outline-success">답변수정</a>
                                                    <?php }else{ ?>
                                                        <a href="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/write_answer.php?id=<?php echo $r['id'];?>" class="btn btn-sm btn-outline-success">답변</a>
                                                    <?php } ?>
...
<script>
    ...
    btnDelete.bind('click', function (e) {
        ...
        swal({
            ...
            if(isConfirm){
                axios.get('/api/qna/delete_board_by_id.php?id=' + _notice_id)
                    .then(function (res) {
                        if(res.data.success){
                            swal(
                                '삭제!',
