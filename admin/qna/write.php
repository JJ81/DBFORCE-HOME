...
<!--                                        </div>-->
                                        <div class="col-lg-6 col-md-6">
                                            <div class="form-group">
                                                <label for="">작성자</label>
                                                <input type="text" name="author" class="form-control form-author" placeholder="작성자를 입력해 주세요." value="한국경제투자TV" required />
                                            </div>
                                        </div>
<!--                                        <div class="col-lg-6 col-md-6">-->
<!--                                            <div class="form-group">-->
...
<!--                                        <textarea name="ir1" id="ir1" rows="10" cols="100" style="width: 100%; height:412px; display:none;"></textarea>-->
                                        <textarea name="ir1" rows="10" cols="100" style="width: 100%; height:412px;" class="form-control" required></textarea>
                                    </div>
                                    <!-- smart editor -->
