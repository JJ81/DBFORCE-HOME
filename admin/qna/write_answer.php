                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="_container">
                                ...
                                <div class="col-lg-12">
                                    <form action="<?php echo ROOT;?>admin/<?php echo TARGET_FOLDER;?>/response/res_write_answer.php"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="author" class="form-control form-author" placeholder="작성자를 입력해 주세요."  value="한국경제투자TV" />
                                                </div>
                                            </div>
