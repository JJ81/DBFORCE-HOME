                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="_container">
                                <form action="<?php echo ROOT;?>admin/notice/response/res_modify.php" method="post" enctype="multipart/form-data" class="form">
                                    <div class="row">
                                    ...
                                    <div style="text-align: center;margin-top: 10px;">
                                        <a href="<?php echo ROOT;?>admin/notice/" class="btn btn-outline-danger">작성취소</a>
