...
$insertId=$notice->setList($title, $thumbnail, $html, $author, $hits, $external_link, $link_origin, $date);

if(!empty($insertId)){
    Redirect(ROOT . 'admin/notice/modify.php?id=' . $insertId);
}else{
    AlertMsgAndRedirectTo(ROOT . 'admin/notice/', '알 수 없는 오류가 발생했습니다. 공지사항을 다시 작성해 주세요.');
}
