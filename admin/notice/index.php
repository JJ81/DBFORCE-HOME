...
$rows=$notice->getList($offset, $size);
?>
                                    ...
                                    <?php }else{ ?>
                                        <?php foreach ($rows as $r) { ?>
                                            <tr>
                                                ...
                                                <td>
<!--                                                    <a href="--><?php //echo ROOT;?><!--admin/--><?php //echo TARGET_FOLDER;?><!--/view.php?id=--><?php //echo $r['id'];?><!--" class="btn btn-sm btn-outline-success">보기</a>-->
                                ...
                                <?php if(count($rows) !== 0){ ?>
                                    <nav class="clearfix" style="margin-top: 20px;position: relative;" >
                                        <ul class="pagination pull-left">
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/notice/?size=<?php echo $size;?>&page=1" tabindex="-1">First</a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/notice/?size=<?php echo $size;?>&page=<?php echo $prev;?>" tabindex="-1">Previous</a>
                                            </li>
                                            <li class="page-item">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/notice/?size=<?php echo $size;?>&page=<?php echo $next;?>">Next</a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link"
                                                   href="<?php echo ROOT;?>admin/notice/?size=<?php echo $size;?>&page=<?php echo $total_page;?>" tabindex="-1">Last</a>
                                            </li>
                                        </ul>
                                    </nav>
                                <?php } ?>
...
<script>
    ...
    btnDelete.bind('click', function (e) {
        ...
        swal({
            ...
            if(isConfirm){
                axios.get('/api/notice/delete_notice_by_id.php?id=' + _notice_id)
                    .then(function (res) {
                        if(res.data.success){
                            swal(
                                '삭제!',
