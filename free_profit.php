...
define('PAGE_NAME', 'BLACK MEMBERSHIP 투자성과');
define('PAGE_PATH', 'free_profit');


require_once ('./inc/common-data.php');


use JCORP\Business\FreeProfitService\FreeProfitService as FreeProfitService;
$inc=new FreeProfitService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-free-profit.jpg?v=1" alt="" width="100%" />
        </div>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-free-invest.jpg?v=1" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">BLACK MEMBERSHIP</span>
            </div>
