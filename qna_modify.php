...
<head>
    ...
    <title><?php echo $info[0]['title'];?>, 1:1문의</title>
</head>
    ...
    <div id="jp-content-m">
        ...
        <div class="form-member-post-write-page-m">
            <div class="form-member-post-write-page">
                <h2 class="page-header-pc">1:1문의 수정</h2>
                <div class="jp-alert-info">※ 내용을 입력하신 다음 “확인” 버튼을 눌러주세요.</div>
                <form action="<?php echo ROOT;?>response/res_modify_qna.php" method="post" enctype="multipart/form-data" class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(!empty($info2[0]['thumbnail'])){ ?>
                                    <img src="<?php echo ROOT;?>assets/uploads/qna_profit/<?php echo $info2[0]['thumbnail'];?>" alt="" />
                                <?php }else{ ?>
                                    등록된 이미지가 없습니다.
                                <?php } ?>
                            </td>
