...
define('PAGE','BEST_PROFIT');
define('PAGE_NAME', '베스트수익후기');
define('PAGE_PATH', 'best_profit');


require_once ('./inc/common-data.php');


use JCORP\Business\BestProfitService\BestProfitService as BestProfitService;
$inc=new BestProfitService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m" style="padding-bottom: 0;">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-best-profit.jpg" alt="" width="100%" />
        </div>

        <div class="page-pc-best-profit-top">
            <div class="page-pc-best-profit-head">
                <img src="<?php echo ROOT;?>assets/img/pc/img-tit-best-top-3.png" alt="" style="max-width: 220px;width: 100%;" />
            </div>
            <div class="page-pc-best-profit-body clearfix">
                <?php if(!empty($rank_lists[0])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="./best_profit_view.php?id=<?php echo $rank_lists[0]['id'];?>">
                            <div class="rank-head">
                                <img src="<?php echo ROOT;?>assets/img/pc/img-best-cap-1.png" alt="" />
                            </div>
                            <div class="rank-body">
                                    <span class="thumbnail-wrp">
                                        <img src="<?php echo ROOT;?>assets/uploads/best_profit/<?php echo $rank_lists[0]['thumbnail'];?>" alt="" width="100%" />
                                    </span>
                            </div>
                        </a>
                    </div>
                ...
                <?php if(!empty($rank_lists[1])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="./best_profit_view.php?id=<?php echo $rank_lists[1]['id'];?>">
                            <div class="rank-head">
                                <img src="<?php echo ROOT;?>assets/img/pc/img-best-cap-2.png" alt="" />
                            </div>
                            <div class="rank-body">
                                    <span class="thumbnail-wrp">
                                        <img src="<?php echo ROOT;?>assets/uploads/best_profit/<?php echo $rank_lists[1]['thumbnail'];?>" alt="" width="100%" />
                                    </span>
                            </div>
                        </a>
                    </div>
                ...
                <?php if(!empty($rank_lists[2])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="./best_profit_view.php?id=<?php echo $rank_lists[2]['id'];?>">
                            <div class="rank-head">
                                <img src="<?php echo ROOT;?>assets/img/pc/img-best-cap-3.png" alt="" />
                            </div>
                            <div class="rank-body">
                                    <span class="thumbnail-wrp">
                                        <img src="<?php echo ROOT;?>assets/uploads/best_profit/<?php echo $rank_lists[2]['thumbnail'];?>" alt="" width="100%" />
                                    </span>
                            </div>
                        </a>
                    </div>
        ...
        <div class="page-pc-table-body-wrp">
            <div class="page-m-table-head">
                <img src="<?php echo ROOT;?>assets/img/pc/img-tit-best-profit.jpg" alt="" style="max-width: 220px;width: 100%;" />
            </div>
                ...
                <?php for($i=0,$size=count($lists);$i<$size;$i++){?>
                    <div class="page-pc-thumbnail-list page-pc-thumbnail-list-type-B">
                        <a href="<?php echo ROOT;?><?php echo PAGE_PATH;?>_view.php?id=<?php echo $lists[$i]['id'];?>">
                            <span class="thumbnail-wrp">
                                <img src="<?php echo ROOT;?>assets/uploads/best_profit/<?php echo $lists[$i]['thumbnail'];?>" alt="" width="100%" />
                            </span>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-best.jpg" alt="" />
        </div>

        <div class="page-pc-tab-area center">
            <?php require_once ('./inc/tab-pc-profit.php');?>
        </div>

        <div class="page-pc-body-area">
            <div class="page-pc-best-profit-top">
                <div class="page-pc-best-profit-head">
                    <img src="<?php echo ROOT;?>assets/img/pc/img-tit-best-top-3.png" alt="" />
                </div>
                <div class="page-pc-best-profit-body clearfix">
                    <?php if(!empty($rank_lists[1])){ ?>
                        <div class="page-pc-best-profit-rank" style="top: 10px;">
                            <a href="./best_profit_view.php?id=<?php echo $rank_lists[1]['id'];?>">
                                <div class="rank-head">
                                    <img src="<?php echo ROOT;?>assets/img/pc/img-best-cap-2.png" alt="" />
                                </div>
                    ...
                    <?php } ?>
                    <?php if(!empty($rank_lists[2])){ ?>
                        <div class="page-pc-best-profit-rank" style="top: 30px;">
                            <a href="./best_profit_view.php?id=<?php echo $rank_lists[2]['id'];?>">
                                <div class="rank-head">
                                    <img src="<?php echo ROOT;?>assets/img/pc/img-best-cap-3.png" alt="" />
                                </div>
            ...
            <div class="page-pc-table-head center">
                <img src="<?php echo ROOT;?>assets/img/pc/img-tit-best-profit.jpg" alt="" />
            </div>
