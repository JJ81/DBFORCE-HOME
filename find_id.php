...
<head>
    ...
    <title><?php echo $info[0]['title'];?>, 아이디/비밀번호 찾기</title>
</head>
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="page-m-header">
            <h2 class="center">
                <img src="<?php echo ROOT;?>assets/img/mobile/login/img-tit-find-id.jpg" alt="" width="70" />
            </h2>
            <h3 class="center" style="padding-top: 5px;">
                <img src="<?php echo ROOT;?>assets/img/mobile/login/img-tit-find-id-sub.jpg" alt="" width="240" />
            </h3>
        </div>
        ...
        <div class="page-m-content">
            ...
            <div class="login-m-wrp">
                <form action="<?php echo ROOT;?>find_id_result.php" method="post" class="form-login">
    ...
    <div class="contents-pc">
        <div class="register-form-wrp">
            <div class="register-form-body">
                <h2 class="register-form-title">아이디 찾기</h2>
                <div class="register-form-desc">회원정보에 저장된 이메일 주소로 아이디를 찾을 수 있습니다.</div>

                <div class="register-form-body-wrp">
                    <form action="<?php echo ROOT;?>find_id_result.php" method="post" class="form-register">
                        <div class="form-group">
