...
$id=getDataByGet('id');
if(empty($id)){
    AlertMsgAndRedirectTo(ROOT . 'profit.php', '잘못된 접근입니다.');
    exit;
}
...
$profit->increaseCount($id);
$notice_info=$profit->getListById($id);

if($notice_info[0]['is_delete'] == '1' or count($notice_info) === 0){
    AlertMsgAndRedirectTo(ROOT . 'profit.php', '존재하지 않는 글입니다.');
    exit;
}


$prevAndNext=$profit->getBoardPrevAndNext($id);
...
<?php if(isMobile()){ ?>
    ...
    <div id="vt-content-m">
                ...
                <?php if(!empty($notice_info[0]['thumbnail'])) { ?>
                    <tr>
                        <td class="center" style="padding: 20px 0;">
                            <img src="<?php ROOT;?>assets/uploads/profit/<?php echo $notice_info[0]['thumbnail'];?>"
        ...
        <div class="as-notice-bottom-btn-area">
            <a href="<?php echo ROOT;?>profit.php">목록으로</a>
        </div>
    ...
    <div class="vt-contents">
        <div class="vt-contents-inner">
            ...
            <div class="vt-content-body" style="padding-bottom: 100px;">
                    ...
                    <?php if(!empty($notice_info[0]['thumbnail'])) { ?>
                        <tr>
                            <td class="center" style="padding: 50px 0;">
                                <img src="<?php ROOT;?>assets/uploads/profit/<?php echo $notice_info[0]['thumbnail'];?>"
                                     alt="<?php echo $notice_info[0]['title'] ;?>" style="max-width: 900px;" />
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                ...
                <div class="as-notice-bottom-btn-area">
                    <a href="<?php echo ROOT;?>profit.php" style="background: #c1272d;">목록으로</a>
                </div>
