...
$id=getDataByGet('id');
if(empty($id)){
    AlertMsgAndRedirectTo(ROOT . 'center.php', '잘못된 접근입니다.');
    exit;
}
...
if($notice_info[0]['is_delete'] == '1' or count($notice_info) === 0){
    AlertMsgAndRedirectTo(ROOT . 'center.php', '존재하지 않는 글입니다.');
    exit;
}
...
<?php if(isMobile()){ ?>
    ...
    <div id="vt-content-m">
                    ...
                    <tr>
                        <td class="as-notice-move-area">
                            <?php if(!empty($prev_id)) {?>
                                <a href="<?php echo ROOT;?>center_view.php?id=<?php echo $prev_id;?>" class="as-notice-prev"> < 이전글 </a>
                            <?php } ?>
                            <?php if(!empty($next_id)) {?>
                                <a href="<?php echo ROOT;?>center_view.php?id=<?php echo $next_id;?>" class="as-notice-next"> 다음글 > </a>
                            <?php } ?>
                        </td>
                    </tr>
                    </tfoot>
        ...
        <div class="as-notice-bottom-btn-area">
            <a href="<?php echo ROOT;?>center.php">목록으로</a>
        </div>
