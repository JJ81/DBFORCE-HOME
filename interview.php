...
define('PAGE_NAME', '고객인터뷰');
define('PAGE_PATH', 'interview');


require_once ('./inc/common-data.php');


use JCORP\Business\InterviewService\InterviewService as InterviewService;
$inc=new InterviewService();
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m" class="jp-con-m-interview">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-interview.jpg" alt="" width="100%" />
        </div>


        <div class="page-pc-table-body-wrp" style="padding: 0;">
            <div class="page-pc-thumbnail-body clearfix" style="border-top: 1px solid #b5b5b5;">
                <?php for($i=0,$size=count($lists);$i<$size;$i++){?>
                    <div class="page-pc-thumbnail-list">
                        <a href="<?php echo ROOT;?><?php echo PAGE_PATH;?>_view.php?id=<?php echo $lists[$i]['id'];?>">
                                <span class="thumbnail-wrp">
                                    <img src="<?php echo ROOT;?>assets/img/common/ico-play-red.png" alt="" class="ico-play-red" />
                                    <img src="https://img.youtube.com/vi/<?php echo $lists[$i]['youtube_link'];?>/hqdefault.jpg" alt="" width="100%" />
                                </span>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-interview.jpg" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">고객인터뷰</span>
            </div>
