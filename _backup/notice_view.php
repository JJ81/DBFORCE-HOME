...
define('PAGE_PATH', 'notice_view');
define('PAGE_ORIGIN', 'notice');
        ...
        <div class="jp-board-info-wrp">
            <div class="jp-board-info-head">
                ...
                <div class="jp-board-info-title-sub">
                    ...
                    <span class="splitter">|</span>
                    <?php echo separateCommaNumber($notice_info[0]['count']);?>
                </div>
            </div>

            <div class="jp-board-info-body">
                <div class="editHtmlArea"><?php echo html_entity_decode($notice_info[0]['contents']) ?></div>
            </div>
