...
<?php if(isMobile()){ ?>
    ...
    <div id="vt-content-m" style="padding-bottom: 50px;">
            ...
            <tr>
                <td>
                    <?php if(empty($lists[$i]['external_link'])){?>
                        <a href="<?php echo ROOT;?>group_view.php?id=<?php echo $lists[$i]['id'];?>">
        ...
        <div class="vt-table-pagination">
            <a href="<?php echo ROOT;?>group.php?page=1" class="vt-paging vt-paging-first"> << </a>
            <a href="<?php echo ROOT;?>group.php?page=<?php echo $current_prev_page;?>" class="vt-paging vt-paging-prev"> < </a>

            <?php for($p=$current_start_page_num,$size=$current_last_page_num;$p<=$size;$p++){?>
                <a href="<?php echo ROOT;?>group.php?page=<?php echo $p;?>"
                   class="vt-paging <?php if($page == $p){ echo 'vt-paging-current';};?>"><?php echo $p;?></a>
            <?php } ?>

            <a href="<?php echo ROOT;?>group.php?page=<?php echo $current_next_page;?>" class="vt-paging vt-paging-next"> > </a>
            <a href="<?php echo ROOT;?>group.php?page=<?php echo $total_last_page_num ;?>" class="vt-paging vt-paging-end"> >> </a>
        </div>
