            ...
            <div class="page-pc-best-profit-body clearfix">
                <?php if(!empty($rank_lists[0])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="best_profit_view.phpd=<?php echo $rank_lists[0]['id'];?>">
                            <div class="rank-head">
                ...
                <?php if(!empty($rank_lists[1])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="best_profit_view.phpd=<?php echo $rank_lists[1]['id'];?>">
                            <div class="rank-head">
                ...
                <?php if(!empty($rank_lists[2])){ ?>
                    <div class="page-pc-best-profit-rank">
                        <a href="best_profit_view.phpd=<?php echo $rank_lists[2]['id'];?>">
                            <div class="rank-head">
