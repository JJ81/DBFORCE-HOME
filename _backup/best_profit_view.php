...
define('PAGE_PATH', 'best_profit_view');
define('PAGE_ORIGIN', 'best_profit');
    ...
    <div id="jp-content-m">
        ...
        <div class="jp-board-info-wrp">
            <div class="jp-board-info-head">
                ...
                <div class="jp-board-mid-info">
                    상품명: <?php echo $inc_info[0]['stock_title'];?>
                    <span class="splitter">|</span>
                    수익금: <span class="txt-red"><?php echo $inc_info[0]['max_profit_price'];?></span>
                    <span class="splitter">|</span>
                    수익률: <span class="txt-red"><?php echo $inc_info[0]['max_profit_rate'];?></span>
                </div>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-body-area">
            ...
            <div class="jp-pc-display-thumbnail">
                <img src="<?php echo ROOT;?>assets/uploads/best_profit/<?php echo $inc_info[0]['thumbnail'];?>" alt="" />
            </div>
