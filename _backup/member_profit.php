...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-member-profit.jpg" alt="" width="100%" />
        </div>

        <div class="page-pc-table-body-wrp" style="padding: 0;margin-top: 10px;">
            <div class="page-pc-thumbnail-body clearfix" style="border-top: 1px solid #b5b5b5;">
                <?php for($i=0,$size=count($lists);$i<$size;$i++){?>
                    <div class="page-pc-thumbnail-list page-pc-thumbnail-list-type-C">
                        <a href="<?php echo ROOT;?><?php echo PAGE_PATH;?>_view.php?id=<?php echo $lists[$i]['id'];?>">
                            <span class="thumbnail-wrp">
                                <img src="<?php echo ROOT;?>assets/uploads/member_profit/<?php echo $lists[$i]['thumbnail'];?>" alt="" width="100%" />
                            </span>
        ...
        <div class="member-profit-list-foot">
            <a href="<?php echo ROOT;?>member_profit_write.php" class="btn-post-write">
                <img src="<?php echo ROOT;?>assets/img/pc/img-btn-post-write.jpg" alt="" width="220" />
            </a>
        </div>
    </div>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">실시간수익후기</span>
                <a href="<?php echo ROOT;?>member_profit_write.php" class="btn-post-write">
                    <img src="<?php echo ROOT;?>assets/img/pc/img-btn-post-write.jpg" alt="" width="220" />
                </a>
            </div>
