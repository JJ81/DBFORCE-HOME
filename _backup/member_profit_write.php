...
<head>
    ...
    <title><?php echo $info[0]['title'];?>, 실시간수익인증 글쓰기</title>
</head>
    ...
    <div id="jp-content-m">
        ...
        <div class="form-member-post-write-page-m">
            <div class="form-member-post-write-page">
                <h2 class="page-header-pc">실시간수익인증입력</h2>
                <div class="jp-alert-info">※ 내용을 입력하신 다음 “확인” 버튼을 눌러주세요.</div>
                <form action="<?php echo ROOT;?>response/res_write_profit.php" method="post" enctype="multipart/form-data" class="form">
