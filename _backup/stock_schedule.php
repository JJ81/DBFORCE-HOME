...
define('PAGE_PATH', 'stock_schedule');
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-stock-schedule.jpg" alt="" width="100%" />
        </div>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">증시일정</span>
            </div>
