...
define('PAGE_NAME', '일일시황');
define('PAGE_PATH', 'daily_news');
...
<?php if(isMobile()){ ?>
    ...
    <div id="jp-content-m">
        <div class="jp-page-banner-m">
            <img src="<?php echo ROOT;?>assets/img/mobile/banner/ban-m-daily-news.jpg" alt="" width="100%" />
        </div>
...
<?php } else { ?>
    ...
    <div class="contents-pc">
        ...
        <div class="page-pc-banner-area">
            <img src="<?php echo ROOT;?>assets/img/banner/pc/img-pc-ban-daily-news.jpg" alt="" />
        </div>
        ...
        <div class="page-pc-body-area">
            <div class="page-pc-table-head">
                한국경제투자TV <span class="red-emphasis">일일시황</span>
            </div>
