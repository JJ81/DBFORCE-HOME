...
define('PAGE_PATH', 'review_profit_view');
define('PAGE_ORIGIN', 'review_profit');
...
<!--                    <span class="splitter">|</span>-->
            ...
            <div class="jp-pc-display-thumbnail">
                <img src="<?php echo ROOT;?>assets/uploads/review_profit/<?php echo $inc_info[0]['thumbnail'];?>" alt="" />
            </div>
